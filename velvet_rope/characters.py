...
VIVIENNE = Character(
    ...
    tactic_keywords=(
        ...
        ("paradox_spotting", ("contradiction", "contradictions", "paradox", "impossible", "duplicate", "triplicate", "same form", "missing form", "form says", "already filed", "crossing error", "error crossing")),
        ...
        ("paperwork_respect", ("paperwork", "forms", "form", "intake", "dream", "dream state", "dream placement", "sleep", "sleeping", "placement", "case file", "case number", "stamp", "filing", "ledger", "clean record", "tidy", "neat", "process", "procedure")),
